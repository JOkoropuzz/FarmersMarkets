...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Markets',
            fields=[
                ('fmid', models.CharField(primary_key=True, serialize=False)),
                ('marketname', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('updatetime', models.CharField(blank=True, max_length=255, null=True)),
            ],
            options={
                'db_table': 'markets',
                'managed': False,
